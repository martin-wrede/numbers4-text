...
function createRenderer(roots2, getEventPriority2) {
  ...
  const reconciler2 = (0, import_react_reconciler.default)({
    ...
    getCurrentEventPriority: () => getEventPriority2 ? getEventPriority2() : import_constants.DefaultEventPriority,
    now: typeof performance !== "undefined" && is.fun(performance.now) ? performance.now : is.fun(Date.now) ? Date.now : void 0,
...
function createLoop(roots2) {
  ...
  function loop(timestamp) {
    ...
    if (globalAfterEffects.length)
      run(globalAfterEffects, timestamp);
    if (repeat === 0) {
      if (globalTailEffects.length)
  ...
  return {
    configure(props = {}) {
      ...
      if (!is.equ(size, state.size, shallowLoose))
        state.setSize(size.width, size.height, size.updateStyle);
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-O7LO4BYP.js.map
