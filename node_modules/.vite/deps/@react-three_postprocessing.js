...
// node_modules/screen-space-reflections/ScreenSpaceReflections.js
...
var SSRCompositeMaterial = class extends ShaderMaterial {
  constructor() {
    super({
...
var NormalDepthRoughnessMaterial = class extends ShaderMaterial {
  constructor() {
    super({
...
var ReflectionsPass = class extends Pass {
  constructor(scene, camera, options = {}) {
    ...
    for (const key of Object.keys(options)) {
      if (this.fullscreenMaterial.uniforms[key] !== void 0) {
    ...
    _classPrivateFieldSet(this, _useMRT, options.useMRT && WebGL_default.isWebGL2Available());
...
function _setNormalDepthRoughnessMaterialInScene2() {
  this._scene.traverse((c2) => {
    if (c2.material) {
      const origMat = c2.material;
      _classPrivateFieldGet(this, _defaultMaterials)[c2.material.uuid] = origMat;
      if (_classPrivateFieldGet(this, _normalDepthMaterials)[origMat.uuid] === void 0) {
        _classPrivateFieldGet(this, _normalDepthMaterials)[origMat.uuid] = new NormalDepthRoughnessMaterial();
        const normalDepthMaterial2 = _classPrivateFieldGet(this, _normalDepthMaterials)[origMat.uuid];
        if (_classPrivateFieldGet(this, _useMRT)) {
          normalDepthMaterial2.defines.USE_MRT = "";
        }
        normalDepthMaterial2._originalUuid = c2.material.uuid;
        normalDepthMaterial2.normalScale = origMat.normalScale;
        normalDepthMaterial2.uniforms.normalMap = new Uniform(null);
        normalDepthMaterial2.uniforms.normalMap.value = origMat.normalMap;
        Object.defineProperty(normalDepthMaterial2.uniforms.roughness, "value", {
          get() {
        ...
        if (_classPrivateFieldGet(this, _options).useNormalMap && origMat.normalMap) {
          normalDepthMaterial2.normalMap = origMat.normalMap;
          normalDepthMaterial2.defines.USE_NORMALMAP = "";
        }
        if (_classPrivateFieldGet(this, _options).useRoughnessMap && origMat.roughnessMap) {
          normalDepthMaterial2.uniforms.roughnessMap.value = origMat.roughnessMap;
          normalDepthMaterial2.defines.USE_ROUGHNESSMAP = "";
        }
        normalDepthMaterial2.uniforms.normalScale.value = origMat.normalScale;
        const map = origMat.map || origMat.normalMap || origMat.roughnessMap || origMat.metalnessMap;
        if (map)
          normalDepthMaterial2.uniforms.uvTransform.value = map.matrix;
      }
      const normalDepthMaterial = _classPrivateFieldGet(this, _normalDepthMaterials)[c2.material.uuid];
      c2.material = normalDepthMaterial;
    }
  });
}
function _unsetNormalDepthRoughnessMaterialInScene2() {
  this._scene.traverse((c2) => {
    if (c2.material)
      c2.material = _classPrivateFieldGet(this, _defaultMaterials)[c2.material._originalUuid];
  });
}
var defaultOptions = {
...
var SSR = (0, import_react.forwardRef)(function SSR2(_ref, ref) {
  ...
  const [pass] = (0, import_react.useState)(() => new SSRPass(scene, camera, {
